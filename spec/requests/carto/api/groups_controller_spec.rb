  ...
  describe 'Groups editor management' do
    ...
    describe '#index' do
      ...
      it 'returns 401 without authentication' do
        get_json api_v1_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id), {}, @headers do |response|
          response.status.should == 401
        end
      end

      it 'returns groups with pagination metadata v1' do
        get_json api_v1_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, api_key: @org_user_owner.api_key), {}, @headers do |response|
      ...
      it 'returns groups v2 with pagination metadata' do
        get_json api_v2_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.name, api_key: @org_user_owner.api_key), {}, @headers do |response|
          response.status.should == 200
          expected_response = {
              groups: [ @group_1_json, @group_2_json, @group_3_json ]
          }
      ...
      it 'returns paginated groups with pagination metadata' do
        get_json api_v1_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, api_key: @org_user_owner.api_key), { page: 2, per_page: 1, order: 'display_name' }, @headers do |response|
          response.status.should == 200
          expected_response = {
            groups: [ @group_2_json ],
            total_entries: 3
      ...
      it 'can search by name v1' do
        get_json api_v1_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, api_key: @org_user_owner.api_key, q: @group_2.name), { page: 1, per_page: 1, order: 'display_name' }, @headers do |response|
          response.status.should == 200
          expected_response = {
              groups: [ @group_2_json ],
              total_entries: 1
      ...
      it 'can search by name v2' do
        get_json api_v2_organization_groups_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.name, api_key: @org_user_owner.api_key, q: @group_2.name), { page: 1, per_page: 1, order: 'display_name' }, @headers do |response|
          response.status.should == 200
          expected_response = {
              groups: [ @group_2_json ]
          }
    ...
    it '#show returns a group v1' do
      get_json api_v1_organization_groups_show_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: @group_1.id, api_key: @org_user_owner.api_key), { }, @headers do |response|
        response.status.should == 200
        response.body.should == @group_1_json.symbolize_keys
      end
    end

    it '#show returns a group v2' do
      get_json api_v2_organization_groups_show_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.name, group_id_or_name: @group_1.name, api_key: @org_user_owner.api_key), { }, @headers do |response|
        response.status.should == 200
        response.body.should == @group_1_json.symbolize_keys
      end
    end

    it '#show support fetch_shared_maps_count, fetch_shared_tables_count and fetch_users v1' do
      get_json api_v1_organization_groups_show_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: @group_1.id, api_key: @org_user_owner.api_key, fetch_shared_tables_count: true, fetch_shared_maps_count: true, fetch_users: true), { }, @headers do |response|
        response.status.should == 200
    ...
    it '#show support fetch_shared_maps_count, fetch_shared_tables_count and fetch_users v2' do
      get_json api_v2_organization_groups_show_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.name, group_id_or_name: @group_1.name, api_key: @org_user_owner.api_key, fetch_shared_tables_count: true, fetch_shared_maps_count: true, fetch_users: true), { }, @headers do |response|
        response.status.should == 200
        response.body[:shared_tables_count].should_not be_nil
        response.body[:shared_maps_count].should_not be_nil
        response.body[:users].should_not be_nil
    ...
    it '#create fails if user is not owner' do
      post_json api_v1_organization_groups_create_url(user_domain: @org_user_1.username, id_or_name: @carto_organization.id, api_key: @org_user_1.api_key), { display_name: 'willfail' }, @headers do |response|
    ...
    it '#create triggers group creation' do
      ...
      post_json api_v1_organization_groups_create_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, api_key: @org_user_owner.api_key), { display_name: display_name }, @headers do |response|
        response.status.should == 200
    ...
    it '#update triggers group renaming' do
      ...
      put_json api_v1_organization_groups_update_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { display_name: new_display_name }, @headers do |response|
        response.status.should == 200
        response.body[:id].should_not be_nil
        response.body[:organization_id].should == @carto_organization.id
    ...
    it '#update returns 409 and a meaningful error message if there is a group with the same name within the organization' do
      ...
      put_json api_v1_organization_groups_update_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { display_name: group_2.display_name }, @headers do |response|
    ...
    it '#add_users triggers group inclusion' do
      ...
      post_json api_v1_organization_groups_add_users_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { user_id: user.id }, @headers do |response|
        response.status.should == 200
    ...
    it '#remove_users triggers group exclusion' do
      ...
      delete_json api_v1_organization_groups_remove_users_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key, user_id: user.id), {}, @headers do |response|
        response.status.should == 200
        # INFO: since test doesn't actually trigger the extension we only check expectation on membership call
      end
    end
    ...
    it '#add_users allows batches and triggers group inclusion' do
      ...
      post_json api_v1_organization_groups_add_users_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { users: [ user_1.id, user_2.id ] }, @headers do |response|
        response.status.should == 200
        # INFO: since test doesn't actually trigger the extension we only check expectation on membership call
      end
    end
    ...
    it '#remove_users allows batches and triggers group exclusion' do
      ...
      delete_json api_v1_organization_groups_remove_users_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { users: [ user_1.id, user_2.id ] }, @headers do |response|
        response.status.should == 200
        # INFO: since test doesn't actually trigger the extension we only check expectation on membership call
      end
    end
    ...
    it '#drops triggers deletion of existing groups' do
      ...
      delete_json api_v1_organization_groups_destroy_url(user_domain: @org_user_owner.username, id_or_name: @carto_organization.id, group_id_or_name: group.id, api_key: @org_user_owner.api_key), { }, @headers do |response|
